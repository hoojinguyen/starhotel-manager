...
class Version20190808100912 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $paramGuests =
            [
                ['1', $tenantId, 'Nguyễn Văn Hội', 'Nam', '098772383', '215465936', '2030-10-03', '2015-10-03', 'Bình Định', '1998', 'Thủ đức, Hồ Chí Minh', '', '', '', ''],
                ['2', $tenantId, 'Lê Hoài Đức', 'Nam', '0389457021', '215465932', '2030-10-03', '2015-10-03', 'Buôn Mê Thuột', '1992', 'Gò Vấp, Hồ Chí Minh', '', '', '', ''],
                ['3', $tenantId, 'Nguyễn Thị Trúc Quỳnh', 'Nữ', '09821230321', '215465946', '2030-10-03', '2015-10-03', 'Phú Yên', '1989', 'Quận 2, Thảo Điền, Hồ Chí Minh', '', '', '', ''],
                ['4', $tenantId, 'Đặng Thái Bảo', 'Nam', '0398232313', '215465964', '2030-10-03', '2015-10-03', 'Hà Nội', '2002', 'Bình Dương, Hồ Chí Minh', '', '', '', ''],
                ['5', $tenantId, 'Hoàng Lê Bách', 'Nam', '0982314121', '215465236', '2030-10-03', '2015-10-03', 'Hồ Chí Minh', '1996', 'Tây Ninh, Hồ Chí Minh', '', '', '', ''],
                ['6', $tenantId, 'Hoàng Lê An', 'Nam', '0982314121', '215465231', '2030-10-03', '2015-10-03', 'Hồ Chí Minh', '1996', 'Tây Ninh, Hồ Chí Minh', '', '', '', ''],
                ['7', $tenantId, 'Đinh Lê Bách', 'Nam', '0982314121', '215465212', '2030-10-03', '2015-10-03', 'Hồ Chí Minh', '1996', 'Tây Ninh, Hồ Chí Minh', '', '', '', ''],
                ['8', $tenantId, 'Nông Lê Vui', 'Nam', '0982314121', '215465298', '2030-10-03', '2015-10-03', 'Hồ Chí Minh', '1996', 'Tây Ninh, Hồ Chí Minh', '', '', '', ''],
                ['9', $tenantId, 'Tạ Thái Bách', 'Nam', '0982314121', '215465290', '2030-10-03', '2015-10-03', 'Hồ Chí Minh', '1996', 'Tây Ninh, Hồ Chí Minh', '', '', '', ''],
                ['10', $tenantId, 'Trần Thế Khôi', 'Nam', '0982314121', '2154652312', '2030-10-03', '2015-10-03', 'Hồ Chí Minh', '1996', 'Tây Ninh, Hồ Chí Minh', '', '', '', ''],
                ['11', $tenantId, 'Đinh Mạnh Ninh', 'Nam', '0982314121', '215465223', '2030-10-03', '2015-10-03', 'Hồ Chí Minh', '1996', 'Tây Ninh, Hồ Chí Minh', '', '', '', ''],
                ['12', $tenantId, 'Nguyễn An Nam', 'Nam', '0982314121', '215465242', '2030-10-03', '2015-10-03', 'Hồ Chí Minh', '1996', 'Tây Ninh, Hồ Chí Minh', '', '', '', ''],
            ];
